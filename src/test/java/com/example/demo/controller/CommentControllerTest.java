...
public class CommentControllerTest {
    ...
    public void saveComments_HappyPath_ShouldReturnStatus302() throws Exception {
        // When
        ResultActions resultActions = mockMvc.perform(post("/comment").with(csrf()).with(user("anutosh").roles("USER")).param("plusComment", "Test Plus"));
    ...
    public void getComments_HappyPath_ShouldReturnStatus200() throws Exception {
        ...
        // When
        ResultActions resultActions = mockMvc.perform(get("/").with(user("anutosh").roles("USER")));
        ...
        resultActions
                ...
                .andExpect(model().attribute("plusComments", hasItem(
                        allOf(
                                hasProperty("createdBy", is("Anutosh")),
                ...
                .andExpect(model().attribute("starComments", hasItem(
                        allOf(
                                hasProperty("createdBy", is("Ishita")),
